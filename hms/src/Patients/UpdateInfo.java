...
public class UpdateInfo {
    ...
    private void updateContactNumber() {
        //PatientShared.getUserInputHandler().getNextLine(); // To consume any newline left by previous input
    ...
    private void changePassword() {
        ...
        String currentPassword = PatientShared.getUserInputHandler().getNextLine();
